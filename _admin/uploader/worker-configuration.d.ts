/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: b8b479c2a0bd8e21cf4556b1e5f95a23)
...
interface __BaseEnv_Env {
	...
	POLICY_AUD: "REPLACE_WITH_ACCESS_AUD";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TEAM_DOMAIN" | "POLICY_AUD" | "GITHUB_OWNER" | "GITHUB_REPO" | "GITHUB_REF" | "GITHUB_WORKFLOW" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_INSTALLATION_ID" | "GITHUB_APP_PRIVATE_KEY" | "MEDIA_SOURCE_TOKEN" | "LOCAL_ADMIN_BYPASS">> {}
}
